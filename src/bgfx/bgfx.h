...
// Vendored from bgfx commit dcf926f624b9642769f8486e789ec26c74e34f4b and
// modified to try matching MGS4 changes. See README.md in this directory for the
// list of changes and why they are here.
...
namespace bgfx
{
	...
	struct RendererType
	{
		...
		enum Enum
		{
			...
			Vulkan,       //!< Vulkan
			WebGPU,       //!< WebGPU
			Gnmp,         //!< GNMP. Added by the game's fork, see README.md.
	...
	struct Caps
	{
		...
		/// Added to match the game, where sizeof(Caps) is 336 rather than
		/// upstream's 328. Every field above sits at its upstream offset and
		/// nothing in the game reads these last 8 bytes, so they are most
		/// likely trailing alignment. See README.md.
		uint8_t _padMgs4[8];
	};
